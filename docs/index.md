...
### Applications
- [web.md](web.md) — Next.js 15 frontend

### Services
- [scraper.md](scraper.md) — Municipality scrapers + scheduler + health monitor
- [ocr.md](ocr.md) — PDF processing: 3-tier OCR pipeline
...
- [database.md](database.md) — Drizzle ORM schema, migrations, Neon PostgreSQL
